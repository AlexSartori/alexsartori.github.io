...
![Electronic circuit](/assets/posts/lilt-circuit.png)
...
![PCB hatching process](/assets/posts/lilt-pcb.png)
...
![3D model and print of the case](/assets/posts/lilt-case.png)
...
![Assembled thermostat](/assets/posts/lilt-assembled.png)
...
![Thermostat web app made with Python Flask](/assets/posts/lilt-webapp.png)

So that’s it. Feel free to contact me for any question or suggestion. And here’s the final result:

![Finished and mounted thermostat](/assets/posts/lilt-mounted.jpg)
...
![gif](/assets/posts/lilt-thanks.gif)

...
<div class='text-center'>{{ layout.html_video_big_pre_url }}/assets/posts/mbio-rotifero-1.mp4{{ layout.html_video_big_post_url }}</div>
...
<div class='text-center'>{{ layout.html_video_big_pre_url }}/assets/posts/mbio-tard-1.mp4{{ layout.html_video_big_post_url }}</div>
...
<div class='text-center'>{{ layout.html_video_big_pre_url }}/assets/posts/mbio-gast-elegans.mp4{{ layout.html_video_big_post_url }}</div>
...
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-rotifero-3.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-rotifero-4.mp4{{ layout.html_video_half_post_url }}
...
<div class='text-center'>{{ layout.html_video_big_pre_url }}/assets/posts/mbio-rotifero-2.mp4{{ layout.html_video_big_post_url }}</div>
...
<div class='text-center'>{{ layout.html_video_big_pre_url }}/assets/posts/mbio-division.mp4{{ layout.html_video_big_post_url }}</div>
...
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-1.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-2.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-3.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-4.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-5.mp4{{ layout.html_video_half_post_url }}
{{ layout.html_video_half_pre_url }}/assets/posts/mbio-ciliato-6.mp4{{ layout.html_video_half_post_url }}
</div>
